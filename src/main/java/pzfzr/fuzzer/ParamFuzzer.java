...
public class ParamFuzzer {
    ...
    private static final List<PayloadInfo> PAYLOAD_INFOS = Arrays.asList(
            ...
            new PayloadInfo("{param_url_encoded}", "{param_url}"),
            new PayloadInfo("{param_double_url_encoded}", "{param_2url}"),
            new PayloadInfo("{param}#", "{param}#"),
            ...
            new PayloadInfo("{param}%20HTTP/1.1%0D%0AHost:%20{fuzz}.ngcf.wi11.fun%0D%0Ax2x:%20", "{param}CRLF"),
